...
- Read the current PDF: [dark theme](output/pdf/TF2_KOTH_Teleporter_Report_Soft_Dark_v1.7.1.pdf) or [light theme](output/pdf/TF2_KOTH_Teleporter_Report_Light_v1.7.1.pdf)
...
python research/report_figures.py --dark
python research/build_report_pdf.py --output=output/pdf/TF2_KOTH_Teleporter_Report_Light_v1.7.1.pdf
python research/build_report_pdf.py --dark --output=output/pdf/TF2_KOTH_Teleporter_Report_Soft_Dark_v1.7.1.pdf
python research/verify_report_release.py output/pdf/TF2_KOTH_Teleporter_Report_Light_v1.7.1.pdf
python research/verify_report_release.py output/pdf/TF2_KOTH_Teleporter_Report_Soft_Dark_v1.7.1.pdf
```
