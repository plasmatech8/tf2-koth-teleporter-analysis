...
- **Against the defenders' returning cohort, retained L3 can create a +2 return advantage.** This compares our returners with theirs, not the direct L3-versus-L1 comparison below. Retained L3 produces at least four seconds at +2 in five of six multi-player wave scenarios: both alignments with three or four returning players, and one of the two alignments in the two-return model (giving a theoretical 50% chance of +2 when two players per team trade lives).
...
If the existing whole-front state is -1 and a retained tele adds two attackers relative to what actually happened, the counterfactual state is +1. That is a two-player **swing**, with an absolute final advantage of +1.

**Front-line player advantage** counts players who have reached the relevant fighting area and can participate. A living player still rolling out from spawn does not count, which is why the HUD alive count cannot answer the teleporter question.
...
| Deaths and returns | Attackers and defenders die in paired one-for-one trades. In multi-player cases, one attacker returns on each successive four-second attacking wave. Because defenders use eight-second waves, two corresponding defenders may respawn together, depending on the wave alignment. Every result row shows the exact spawn offsets. |
...
The team wave clocks are aligned. For two simultaneous deaths, the defender therefore spawns **4 or 8 seconds** after the attacker, rather than drawing an independent value anywhere in its range. These are the attacker's arrival advantages over the defender, not either player's complete respawn time. The two alignments alternate deterministically with the shared wave clocks; they are not fresh independent coin tosses. A theoretical 50/50 split follows only if paired deaths fall evenly across the two phase bands. The theoretical mean lead is 6 seconds.

> Demo double-check: 199 near-simultaneous opposing death pairs across 45 demos and 111 rounds under stable point ownership produced 116 four-second gaps (58.3%) and 83 eight-second gaps (41.7%); no other gap occurred. Product produced 68/113 four-second gaps (60.2%), while Ashville produced 48/86 (55.8%). The observed mean was **5.68 seconds**.

Exact same-tick trades produced 20/25 four-second gaps (80.0%); the other near-simultaneous pairs produced 96/174 (55.2%). Within the first 30 seconds after the latest capture, 49/75 pairs had four-second gaps (65.3%), compared with 67/124 later pairs (54.0%). Cases where point ownership changed between death and respawn were excluded, so side changes after a capture do not cause this skew. Fight cadence is one possible explanation, but the audit does not establish the cause. The visible KOTH point timer did not reliably reveal the wave phase and does not support a practical "die at timer X" rule.

Because the events cluster within matches, this audit confirms the possible gaps but does not establish a universal alignment probability.
...
| Transfer allowance | 0.6 s | 0.6 s |
| Exit to front | ~4.0 s | ~3.0 s |
| **L3 route to front** | **6.6 s** | **5.6 s** |
...
```text
Attacker: dies at 0.0 -> respawns at 12.4 -> front at 19.0
          (charged L3: 6.6 s travel)
Defender: dies at 0.0 -> respawns at 18.4 -> front at 25.0
          (charged L3: 6.6 s travel)
...
The defender still uses L3. Product no-tele rollout costs the attacker 5.4 seconds relative to L3:
...
### 4. Add the reset and rebuild timeline
...
![Rebuild readiness relative to the first useful entrance arrival](research/report_assets/step-4-rebuild-readiness-timeline.png)
...
![Product scenario 4A shared-tele timelines against defender L3](research/report_assets/step-5-shared-tele-timeline.png)

<pagebreak>

### 6. Work the two-player Product example completely

Scenario 2A uses attack spawn offsets `0, 4` and defence offsets `8, 8`. The fixed 10.4 seconds before the first attacking spawn is omitted from every line because it changes no comparison.
...
- **For the whole front line:** add the return effect to the real pre-existing margin; the return model alone cannot state the final team advantage.
...
This is the main comparison table. **A means the defender's first return is eight seconds behind; B means it is four seconds behind.** Each infrastructure cell shows the return-cohort advantage over defenders in chronological order, followed by net player-seconds. The column order is no tele, rebuilt L1, rebuilt L2 and retained L3; L3 and L1 are highlighted because they are the primary policy comparison.
...
| **2A** | `0, 4` | `8, 8` | **2.6 s of +1**<br>**1.4 s even**<br>**4.0 s of +1**<br>*(+6.6 p·s)* | **8.0 s of +1**<br>**1.4 s even**<br>**4.0 s of +1**<br>*(+12.0 p·s)* | **8.0 s of +1**<br>**1.4 s even**<br>**4.0 s of +1**<br>*(+12.0 p·s)* | **4.0 s of +1**<br>**4.0 s of +2**<br>**5.4 s of +1**<br>*(+17.4 p·s)* | **+5.4 p·s** |
| **2B** | `0, 4` | `4, 12` | **1.4 s of -1**<br>**4.0 s even**<br>**2.6 s of +1**<br>*(+1.2 p·s)* | **4.0 s of +1**<br>**5.4 s even**<br>**2.6 s of +1**<br>*(+6.6 p·s)* | **4.0 s of +1**<br>**5.4 s even**<br>**2.6 s of +1**<br>*(+6.6 p·s)* | **12.0 s of +1**<br>*(+12.0 p·s)* | **+5.4 p·s** |
| **3A** | `0, 4, 8` | `8, 8, 16` | **2.6 s of +1**<br>**1.4 s even**<br>**6.6 s of +1**<br>*(+9.2 p·s)* | **8.0 s of +1**<br>**1.4 s even**<br>**6.6 s of +1**<br>*(+14.6 p·s)* | **9.4 s of +1**<br>**4.0 s of +2**<br>**2.6 s of +1**<br>*(+20.0 p·s)* | **4.0 s of +1**<br>**9.4 s of +2**<br>**2.6 s of +1**<br>*(+25.4 p·s)* | **+10.8 p·s** |
...
| **4A** | `0, 4, 8, 12` | `8, 8, 16, 16` | **2.6 s of +1**<br>**1.4 s even**<br>**6.6 s of +1**<br>**1.4 s even**<br>**4.0 s of +1**<br>*(+13.2 p·s)* | **8.0 s of +1**<br>**1.4 s even**<br>**2.6 s of +1**<br>**4.0 s of +2**<br>**5.4 s of +1**<br>*(+24.0 p·s)* | **9.4 s of +1**<br>**4.0 s of +2**<br>**2.6 s of +1**<br>**1.4 s even**<br>**4.0 s of +1**<br>*(+24.0 p·s)* | **4.0 s of +1**<br>**8.0 s of +2**<br>**1.4 s of +3**<br>**2.6 s of +2**<br>**5.4 s of +1**<br>*(+34.8 p·s)* | **+10.8 p·s** |
| **4B** | `0, 4, 8, 12` | `4, 12, 12, 20` | **1.4 s of -1**<br>**4.0 s even**<br>**2.6 s of +1**<br>**1.4 s even**<br>**6.6 s of +1**<br>*(+7.8 p·s)* | **4.0 s of +1**<br>**5.4 s even**<br>**4.0 s of +1**<br>**4.0 s of +2**<br>**2.6 s of +1**<br>*(+18.6 p·s)* | **4.0 s of +1**<br>**4.0 s even**<br>**1.4 s of +1**<br>**2.6 s of +2**<br>**8.0 s of +1**<br>*(+18.6 p·s)* | **8.0 s of +1**<br>**9.4 s of +2**<br>**2.6 s of +1**<br>*(+29.4 p·s)* | **+10.8 p·s** |
...
The Ashville table uses the same layout and assumptions. Retained-L3 values match Product because equal tele routes cancel within each map. Walking and low-level queue choices differ because Ashville's tele route saves 6.4 seconds rather than Product's 5.4.
...
| **2A** | `0, 4` | `8, 8` | **1.6 s of +1**<br>**2.4 s even**<br>**4.0 s of +1**<br>*(+5.6 p·s)* | **8.0 s of +1**<br>**2.4 s even**<br>**4.0 s of +1**<br>*(+12.0 p·s)* | **8.0 s of +1**<br>**2.4 s even**<br>**4.0 s of +1**<br>*(+12.0 p·s)* | **4.0 s of +1**<br>**4.0 s of +2**<br>**6.4 s of +1**<br>*(+18.4 p·s)* | **+6.4 p·s** |
| **2B** | `0, 4` | `4, 12` | **2.4 s of -1**<br>**4.0 s even**<br>**1.6 s of +1**<br>*(-0.8 p·s)* | **4.0 s of +1**<br>**6.4 s even**<br>**1.6 s of +1**<br>*(+5.6 p·s)* | **4.0 s of +1**<br>**6.4 s even**<br>**1.6 s of +1**<br>*(+5.6 p·s)* | **12.0 s of +1**<br>*(+12.0 p·s)* | **+6.4 p·s** |
| **3A** | `0, 4, 8` | `8, 8, 16` | **1.6 s of +1**<br>**2.4 s even**<br>**5.6 s of +1**<br>*(+7.2 p·s)* | **8.0 s of +1**<br>**2.4 s even**<br>**5.6 s of +1**<br>*(+13.6 p·s)* | **10.4 s of +1**<br>**4.0 s of +2**<br>**1.6 s of +1**<br>*(+20.0 p·s)* | **4.0 s of +1**<br>**10.4 s of +2**<br>**1.6 s of +1**<br>*(+26.4 p·s)* | **+12.8 p·s** |
...
| **4A** | `0, 4, 8, 12` | `8, 8, 16, 16` | **1.6 s of +1**<br>**2.4 s even**<br>**5.6 s of +1**<br>**2.4 s even**<br>**4.0 s of +1**<br>*(+11.2 p·s)* | **8.0 s of +1**<br>**2.4 s even**<br>**1.6 s of +1**<br>**4.0 s of +2**<br>**6.4 s of +1**<br>*(+24.0 p·s)* | **10.4 s of +1**<br>**4.0 s of +2**<br>**1.6 s of +1**<br>**2.4 s even**<br>**4.0 s of +1**<br>*(+24.0 p·s)* | **4.0 s of +1**<br>**8.0 s of +2**<br>**2.4 s of +3**<br>**1.6 s of +2**<br>**6.4 s of +1**<br>*(+36.8 p·s)* | **+12.8 p·s** |
| **4B** | `0, 4, 8, 12` | `4, 12, 12, 20` | **2.4 s of -1**<br>**4.0 s even**<br>**1.6 s of +1**<br>**2.4 s even**<br>**5.6 s of +1**<br>*(+4.8 p·s)* | **4.0 s of +1**<br>**6.4 s even**<br>**4.0 s of +1**<br>**4.0 s of +2**<br>**1.6 s of +1**<br>*(+17.6 p·s)* | **4.0 s of +1**<br>**4.0 s even**<br>**2.4 s of +1**<br>**1.6 s of +2**<br>**8.0 s of +1**<br>*(+17.6 p·s)* | **8.0 s of +1**<br>**10.4 s of +2**<br>**1.6 s of +1**<br>*(+30.4 p·s)* | **+12.8 p·s** |
...
5. Ground is recovered and the route becomes safe. The retained exit could now serve returns; the replacement may still be building or be a lower level.
6. Players die during the next fight. The tables measure how these different tele states change their arrival times.

A sac can become the relevant dry fight if the enemy Medic dies and enough teammates survive to continue. A late spawner can also use a reopened tele to catch up after the team has recovered ground. The benefit depends on when that player could actually participate, not simply on how long the tele was absent.
...
The 199 paired deaths double-check the documented 10.4-14.4 and 14.4-22.4 ranges under these match settings. More useful here, they confirm that actual paired leads were four or eight seconds. The observed mean was 5.68 seconds.

### Unsafe-use candidates

Forty-six recordings with active rounds were screened, covering about 16 hours 7 minutes and 1,934 friendly tele uses. The August 18 instruction match is grouped with the earlier period because it contains no recorded manual exit detonation by this Engineer.

| Period | Recordings | Active play | Friendly tele uses | Reset-like uses | Death within 5 s | Rapid-death screens reviewed |
|---|---:|---:|---:|---:|---:|---:|
| Through Aug 18 instruction match | 34 | 11 h 46.5 min | 1,418 | 41 | 6 | 6 / 6 |
| Later recordings with policy use | 12 | 4 h 20.8 min | 516 | 3 | 1 | 1 / 1 |
| **Total** | **46** | **16 h 7.3 min** | **1,934** | **44** | **7** | **7 / 7** |

The five-second column is a screening result, not seven proven mistakes. Manual visual review has now classified all six older rapid-death scenes, one non-death control and the newer Medic scene. It found two harmful known-reset uses, three other deaths after premature or transition-period uses with different policy implications, one unsafe known-reset use that survived, and two ambiguous or legitimate continuations. These are eight reviewed scenes; they should not be compressed into a single misuse count.
...
A separate active-fight reference resolves the earlier scene mix-up. In July 30 Product, demo 1485728, Engineer used L3 at **tick 64995 / 16:14.92**; viewing around tick 65190 shows Heavy and Medic holding rock. Engineer was then sniped while running up at **tick 65337**, 5.13 seconds after the ride. The audit correctly marked this use as neither a strict nor broad reset candidate. It is not one of the eight screened review scenes above.

A useful control is demo 1494495 at **tick 35921 / 8:58.81**: the same Demoman survives about 122 seconds after what visual review identifies as a clear unsafe known-reset use. A Sniper watched lobby and a Soldier nearly killed him. A death-only metric therefore undercounts unsafe uses, while a position-only metric overcounts legitimate continuations.

The newer Ashville recording adds a clear premature rollout use. Medic used L1 at **tick 125874 / 31:28.11** while most teammates were dead or only beginning to roll out, intending to reunite on bats for a fast dry push. Lobby was not secure; Medic immediately acknowledged that taking the tele was wrong and died 3.36 seconds later. The recording review indicates little charge was lost and suggests a several-second push delay, but does not establish an exact delay. The seven later rides below establish subsequent use of the same connection; their effect on the result remains a counterfactual.
...
*Each coloured bar begins at the modelled retained-L3 front-line arrival and ends at the recorded/no-tele-rollout arrival marker. The bottom strip counts how many additional attackers the retained-L3 counterfactual supplies over what happened. During the overlapping Heavy/Pyro interval, the recorded non-Spy whole-front margin was about -1; adding two earlier arrivals makes the counterfactual about +1. That is a two-player swing and an absolute +1 state.*

The generic route model gives 5.84 seconds at +2. A position-based check shortens that overlap to about **3.6-3.9 seconds** because the actual Heavy and Pyro traversed the map faster than the 300-HU/s baseline route. Manual review finds that this particular overlap was probably useful: the recorded front was roughly -1 while the enemy pressured point, and two earlier arrivals would have changed it to roughly +1. The later Sniper saving was not useful because the team changed route to bats and his walking arrival coincided with the team's staging. This is why the 33.93 p·s raw total should not be reported as 33.93 seconds of useful combat advantage.

A Product construction example shows a long outage without a demonstrated tactical loss. In the September 6 demo, the L2 exit was placed at **tick 34433 / 8:36.50**, finished its roughly 21-second construction at about **tick 35841 / 8:57.62**, was active for about two seconds, then was destroyed at **tick 35978 / 8:59.67**. The next tele pair was unavailable for roughly 37 seconds and for the first 13.7 seconds after the next Über deployment at **tick 37535 / 9:23.02**. Manual review found no useful missing return during the immediate sac/reset action. A later L2 could have helped separated Demo/Engineer returns, but the recording does not show a missed decisive arrival.

The other September 6 scenes are also qualifications, not headline proof. One sac converted into a dry fight after the enemy Medic dropped, but the team already controlled the space and won with little further fighting. One final contest ended before possible Demo/Scout returns could matter. In the grass-door contest, a retained exit might have offered a distraction or alternate Engineer touch, but it was unlikely to change the result.

The Product round-three contest is not evidence that the Engineer should have led the point touch. He upgraded because he expected power classes to enter through concrete first and intended to follow. The chronology can show available time, not replace the intended class order.
...
- **No replacement is usable yet.** Retained L3 can serve even the first useful return. At the 300-HU/s baseline, walking instead adds about 5.4 seconds on Product or 6.4 seconds on Ashville.
...
- **A sac converts into a dry fight, or a partial wipe continues.** If the enemy Medic dies while enough teammates survive, the next fight can begin immediately. Another player may then die before a replacement L1 is ready; a closed retained exit can serve that return once its route becomes safe.
...
- **A premature use would have limited consequences.** An extra death may add little if it does not delay the planned departure or remove a player the team needs.
...
- **A replacement is likely to be ready before anyone needs transport.** This is more plausible when the team expects roughly 7-9 seconds after placement before another death. The normal death-to-spawn and spawn-to-entrance time can then complete the construction window before that player reaches the entrance. What matters is the interval from exit placement to the first relevant death: placing the exit late in staging, or completing staging and beginning the fight more quickly, reduces that interval. An immediate dry fight or deaths during staging shorten it further and increase the value of retained L3.
...
- **An early Engineer respawn can reduce the rebuild penalty.** When the Engineer respawns early during a reset, he can use the waiting time to upgrade the entrance before moving to staging and placing the next exit. In the usual reset, sac wave, reset, dry-fight sequence, the reset after the sac may provide a second upgrade opportunity. This depends on the Engineer's respawn timing and other duties; it can improve the level of the next connection but does not shorten exit construction.
...
- **Repeated lives and critical-heal readiness come from the saved arrival time.** Shorter downtime can make another life available during a long fight, while taking the tele can preserve the fresh-spawn critical-heal ramp by avoiding blast-jump damage. These are tactical consequences of earlier arrival, not additional player-second gains.
...
**Count the change caused by the decision.** For a prevented unsafe use, count additional regroup time, a delayed push or a missed deadline. For a retained tele, count earlier presence only within a useful fight window. A fast arrival during staging may add no immediate combat value.
...
Teleporters turn earlier respawns into earlier front-line presence. With equivalent routes, attackers retain their four- or eight-second spawn lead. With no attacking tele against defender L3, the modelled lead becomes **-1.4/+2.6 seconds on Product** and **-2.4/+1.6 seconds on Ashville**.
...
| **2A** | `0, 4` | `8, 8` | 14.6 L3<br>20.0 walk | 12.0 walk<br>16.0 walk | 6.6 L1<br>16.0 walk | 6.6 L2<br>16.0 walk | 6.6 L3<br>10.6 L3 |
| **2B** | `0, 4` | `4, 12` | 10.6 L3<br>18.6 L3 | 12.0 walk<br>16.0 walk | 6.6 L1<br>16.0 walk | 6.6 L2<br>16.0 walk | 6.6 L3<br>10.6 L3 |
| **3A** | `0, 4, 8` | `8, 8, 16` | 14.6 L3<br>20.0 walk<br>22.6 L3 | 12.0 walk<br>16.0 walk<br>20.0 walk | 6.6 L1<br>16.0 walk<br>20.0 walk | 6.6 L2<br>16.0 walk<br>14.6 L2 | 6.6 L3<br>10.6 L3<br>14.6 L3 |
| **3B** | `0, 4, 8` | `4, 12, 12` | 10.6 L3<br>18.6 L3<br>24.0 walk | 12.0 walk<br>16.0 walk<br>20.0 walk | 6.6 L1<br>16.0 walk<br>20.0 walk | 6.6 L2<br>16.0 walk<br>14.6 L2 | 6.6 L3<br>10.6 L3<br>14.6 L3 |
| **4A** | `0, 4, 8, 12` | `8, 8, 16, 16` | 14.6 L3<br>20.0 walk<br>22.6 L3<br>28.0 walk | 12.0 walk<br>16.0 walk<br>20.0 walk<br>24.0 walk | 6.6 L1<br>16.0 walk<br>20.0 walk<br>18.6 L1 | 6.6 L2<br>16.0 walk<br>14.6 L2<br>24.0 walk | 6.6 L3<br>10.6 L3<br>14.6 L3<br>18.6 L3 |
| **4B** | `0, 4, 8, 12` | `4, 12, 12, 20` | 10.6 L3<br>18.6 L3<br>24.0 walk<br>26.6 L3 | 12.0 walk<br>16.0 walk<br>20.0 walk<br>24.0 walk | 6.6 L1<br>16.0 walk<br>20.0 walk<br>18.6 L1 | 6.6 L2<br>16.0 walk<br>14.6 L2<br>24.0 walk | 6.6 L3<br>10.6 L3<br>14.6 L3<br>18.6 L3 |
...
| **2A** | `0, 4` | `8, 8` | 13.6 L3<br>20.0 walk | 12.0 walk<br>16.0 walk | 5.6 L1<br>16.0 walk | 5.6 L2<br>16.0 walk | 5.6 L3<br>9.6 L3 |
| **2B** | `0, 4` | `4, 12` | 9.6 L3<br>17.6 L3 | 12.0 walk<br>16.0 walk | 5.6 L1<br>16.0 walk | 5.6 L2<br>16.0 walk | 5.6 L3<br>9.6 L3 |
| **3A** | `0, 4, 8` | `8, 8, 16` | 13.6 L3<br>20.0 walk<br>21.6 L3 | 12.0 walk<br>16.0 walk<br>20.0 walk | 5.6 L1<br>16.0 walk<br>20.0 walk | 5.6 L2<br>16.0 walk<br>13.6 L2 | 5.6 L3<br>9.6 L3<br>13.6 L3 |
| **3B** | `0, 4, 8` | `4, 12, 12` | 9.6 L3<br>17.6 L3<br>24.0 walk | 12.0 walk<br>16.0 walk<br>20.0 walk | 5.6 L1<br>16.0 walk<br>20.0 walk | 5.6 L2<br>16.0 walk<br>13.6 L2 | 5.6 L3<br>9.6 L3<br>13.6 L3 |
| **4A** | `0, 4, 8, 12` | `8, 8, 16, 16` | 13.6 L3<br>20.0 walk<br>21.6 L3<br>28.0 walk | 12.0 walk<br>16.0 walk<br>20.0 walk<br>24.0 walk | 5.6 L1<br>16.0 walk<br>20.0 walk<br>17.6 L1 | 5.6 L2<br>16.0 walk<br>13.6 L2<br>24.0 walk | 5.6 L3<br>9.6 L3<br>13.6 L3<br>17.6 L3 |
| **4B** | `0, 4, 8, 12` | `4, 12, 12, 20` | 9.6 L3<br>17.6 L3<br>24.0 walk<br>25.6 L3 | 12.0 walk<br>16.0 walk<br>20.0 walk<br>24.0 walk | 5.6 L1<br>16.0 walk<br>20.0 walk<br>17.6 L1 | 5.6 L2<br>16.0 walk<br>13.6 L2<br>24.0 walk | 5.6 L3<br>9.6 L3<br>13.6 L3<br>17.6 L3 |
